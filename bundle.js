                ...
                Xa = class {
                    ...
                    publish() {
                        ...
                        return {
                          ...
                          //  label: this.name ? this.name + " - " + z.name : z.name,
...
if ('') {
                                ...
                                N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, l.guiwhite, "center")
                                  if (z.name.includes('[A.I.]'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, 150 > Date.now() % 300 ? l.blue : l.blue, "center")
                              if (z.name.includes('Arrasian!'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, 150 > Date.now() % 300 ? l.red : l.red, "center")
                            ...
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Arras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                    ...
                                    } else W[6].draw("Arrasian.io", h + 200, m - 42 - 2, 15, l.guiwhite, "right");
                            ...
                            if (!B.graphical.screenshotMode) {
                                ...
                                for (let a = 0; a < O.data.length && (!b.mobile || 6 > a); a++) {
                                  ...
                                  if (b.label.includes('[A.I.]'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.blue, "center", !0);
                                  if (b.label.includes('Arrasian!'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.red, "center", !0);
            ...
            const Sa = (() => {
                    ...
                    var c = [
                        ...
                        ["Avoid upgrading the reload stat if you wish for a smooth game", "Have Fun!",
                            "Good Luck!", "The password is 4NAX", "The password is Fallen"
                        ]
                    ];
    ...
    // =======================
                ...
                servers: [{
                    ...
                    type: "1ffa",
                    code: "arrasio5",
                    at: p.glitch("arrasian-developer"),
                }, {
                  id: "Glitch-TDM",
                    type: "4tdm",
                    code: "arrasio5",
                    at: p.glitch("arrasian-tdm"),
                  }, {
                    id: "Glitch-Event",
                    type: "1tdm",
                    code: "arrasio5",
                    at: p.glitch("arrasian-event"),
                }
                     ].map((a, e) => ({
                    data: a,
                    i: e
